...
-- # sharding
-- # ==========================================================
select citus_set_coordinator_host('coordinator-2', 5432);

select * from master_add_node('worker-2-0.worker-2-headless.citus.svc.cluster.local', 5432);
select * from master_add_node('worker-2-1.worker-2-headless.citus.svc.cluster.local', 5432);
select * from master_add_node('worker-2-2.worker-2-headless.citus.svc.cluster.local', 5432);
...
-- # replication
-- # ==========================================================
alter subscription coord2_sub_from_master2 disable;

alter subscription coord2_sub_from_master2
set (slot_name = none);

drop subscription coord2_sub_from_master2;
...
create subscription coord2_sub_from_master2
